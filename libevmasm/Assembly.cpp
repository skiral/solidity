...
Assembly& Assembly::optimise(bool _enable, bool _isCreation, size_t _runs)
{
	...
	settings.runConstantOptimiser = _enable;
...
{
	cout << "Running optimiseInternal " << (_settings.isCreation ? "for creation ": "") << " with";
	...
	if (_settings.runConstantOptimiser)
		cout << " constantoptimiser (" << _settings.constantOptimiserTradeoff << ")";
	cout << endl;
	...
	if (_settings.runConstantOptimiser)
		ConstantOptimisationMethod::optimiseConstants(
			...
			_settings.isCreation ? 1 : _settings.constantOptimiserTradeoff,
			*this,
			m_items
		);
